...
# +-------------------------------------------------------------------
# +-------------------------------------------------------------------
namespace sower\driver\template\src;
use sower\App;
use sower\Template;
use sower\template\exception\TemplateNotFoundException;
...
class Sower
{
    ...
    public function __construct(App $app, array $config = [])
    {
        ...
        if (empty($this->config['cache_path'])) {
            $this->config['cache_path'] = $app->getAppPath() . 'Cache' . DIRECTORY_SEPARATOR;
        }
