...
# | 文件缓存类
# +-------------------------------------------------------------------
# | Copyright (c) 2017-2019 SowerFrame rights reserved.
# +-------------------------------------------------------------------
# +-------------------------------------------------------------------
namespace sower\driver\cache\driver;
use sower\App;
use sower\driver\cache\Driver;
use sower\handle\Cache;
class File extends Driver implements Cache
{
    /**
     * 配置参数
     * @var array
