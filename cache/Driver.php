...
namespace sower\driver\cache;
use Psr\SimpleCache\CacheInterface;
use sower\Container;
use sower\exception\InvalidArgumentException;
...
abstract class Driver implements CacheInterface
{
    ...
    {
        $serialize = $this->options['serialize'][0] ?? '\sower\App::serialize';
    ...
    {
        $unserialize = $this->options['serialize'][1] ?? '\sower\App::unserialize';
