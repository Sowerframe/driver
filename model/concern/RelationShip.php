...
use sower\driver\model\relation\BelongsTo;
use sower\driver\model\relation\BelongsToMany;
use sower\driver\model\relation\HasMany;
use sower\driver\model\relation\HasManyThrough;
use sower\driver\model\relation\HasOne;
use sower\driver\model\relation\MorphMany;
use sower\driver\model\relation\MorphOne;
use sower\driver\model\relation\MorphTo;
trait RelationShip
{
    /**
     * 父关联模型对象
    ...
    protected function isRelationAttr(string $attr)
    {
        ...
        if (method_exists($this, $relation) && !method_exists('sower\Model', $relation)) {
            return $relation;
        }
